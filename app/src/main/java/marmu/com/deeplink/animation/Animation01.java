...
public class Animation01 extends Animation {
    public static boolean NEED_PROXY = Build.VERSION.SDK_INT < 11;

    private static final WeakHashMap<View, Animation01> PROXIES = new WeakHashMap<View, Animation01>();

    public static Animation01 wrap(View view) {
        Animation01 proxy = PROXIES.get(view);
        Animation animation = view.getAnimation();
        if (proxy == null || proxy != animation && animation != null) {
            proxy = new Animation01(view);
